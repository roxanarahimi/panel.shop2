...
Route::controller(App\Http\Controllers\UserAddressController::class)->group(function () {
    ...
    Route::post('/address/user/{userAddress}', 'update');
...
//        Route::get('/delete/city/{city}', 'destroy');
//        Route::get('/active/city/{city}', 'activeToggle');
//        Route::get('/latest/city', 'latest');
});
Route::controller(App\Http\Controllers\StateController::class)->group(function () {
        Route::get('/state', 'indexSite');
        Route::get('/state/{state}', 'show');
//        Route::post('/state', 'store');
//        Route::post('/state/{state}', 'update');
//        Route::get('/delete/state/{state}', 'destroy');
//        Route::get('/active/state/{state}', 'activeToggle');
//        Route::get('/latest/state', 'latest');
});
